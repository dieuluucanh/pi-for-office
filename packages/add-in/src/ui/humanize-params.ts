...
const EXTRA_HUMANIZERS = {
  ...
  word_insert_blocks: humanizeHostFormatTool,
  word_insert_table: humanizeHostFormatTool,
  word_insert_page_break: humanizeHostDocumentTool,
  word_insert_image: humanizeHostFormatTool,
  word_insert_hyperlink: humanizeHostDocumentTool,
