...
export const PYTHON_BRIDGE_APPROVED_URL_SETTING_KEY =
 "python.bridge.approved.url";
...
export interface ExperimentalToolGateDependencies
 extends TmuxBridgeGateDependencies,
