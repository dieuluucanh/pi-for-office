...
export const TOOL_UI_METADATA = {
  ...
  word_insert_blocks: { renderer: false, humanizer: false },
  word_insert_table: { renderer: false, humanizer: false },
  word_insert_page_break: { renderer: false, humanizer: false },
  word_insert_image: { renderer: false, humanizer: false },
  word_insert_hyperlink: { renderer: false, humanizer: false },
